...
# Optional: Use variables for sensitive data
...
// sanitizeResourceName sanitizes a name for use as a Terraform resource name
...
// GroupMapping represents the mapping between group IDs and names
...
// GenerateGroupMapping creates a JSON file with group ID to name mappings
func (tg *TerraformGenerator) GenerateGroupMapping() error {
	mappings := make([]GroupMapping, 0)

	// Extract group mappings from generated resources
	for _, resource := range tg.resources {
